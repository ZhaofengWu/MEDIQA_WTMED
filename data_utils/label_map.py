...
# label map
MedNLI_LabelMapper = Vocabulary(True)
MedNLI_LabelMapper.add('contradiction')
MedNLI_LabelMapper.add('neutral')
MedNLI_LabelMapper.add('entailment')
